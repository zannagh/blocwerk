...
internal static partial class ApiDocsData
{
    ...
    [
        ...
        new("PUT", CaptureBase + "/{captureId}/scale-reference", "Make sizes exact (walls without markers): a measured distance on a photo.",
            CaptureOnWall, "{\n  \"photoIndex\": 3,\n  \"a\": [1210.5, 1802],\n  \"b\": [2311, 1795.5],\n  \"mm\": 1200\n}", null,
            "204; DELETE removes it. Points in stored-photo pixels; 409 with the reason when unusable."),
