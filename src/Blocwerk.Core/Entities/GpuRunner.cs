...
/// <see cref="GpuRunnerWall"/> (its owner's walls by default) and, when
/// <see cref="SharedWithOtherWalls"/> is set, any other wall that has no runner of its own online.
/// </remarks>
public class GpuRunner
{
    ...
    /// <summary>"Other walls can use this runner": walls without a runner of their own online may use it.</summary>
